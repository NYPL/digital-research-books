...
def test_hathi_trust_process(db_manager, s3_manager, mock_epub_to_webpub, mock_sqs_manager):
    ...
    records = assert_ingested_records(db_manager, sources=[Source.HATHI.value], expected_number_of_records=number_of_records_ingested)
