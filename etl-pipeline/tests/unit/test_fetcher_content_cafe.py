...
class TestContentCafeFetcher:
    ...
    def test_fetch_volume_cover_success(self, test_fetcher, mocker):
        ...
        mock_get.assert_called_once_with('http://contentcafe2.btol.com/ContentCafe/Jacket.aspx?userID=testUser&password=testPswd&type=L&Value=1', timeout=5, stream=True)
