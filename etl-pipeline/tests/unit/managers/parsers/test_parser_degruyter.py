...
class TestDeGruyterParser:
    ...
    def test_create_links_isbn_match(self, test_parser, mocker):
        parserMocks = mocker.patch.multiple(
            DeGruyterParser,
        ...
        parserMocks["generate_pdf_links"].assert_called_once_with(
            "test_root/",
            "https://www.degruyter.com/document/doi/10.000/9781234567890/pdf",
        )
        parserMocks["generate_epub_links"].assert_called_once_with(
            "test_root/",
            "https://www.degruyter.com/document/doi/10.000/9781234567890/epub",
        )
    ...
    def test_generate_epub_links_success(self, test_parser, mocker):
        ...
        assert test_links == [
            (
                "test_root/epubs/degruyter/1/manifest.json",
                {"reader": True},
            ...
            (
                "test_root/epubs/degruyter/1/META-INF/container.xml",
                {"reader": True},
            ...
            (
                "test_root/epubs/degruyter/1.epub",
                {"download": True},
                "application/epub+zip",
                None,
                ("epubs/degruyter/1.epub", "epub_source_uri"),
            ),
        ]
    ...
    def test_generate_pdf_links(self, test_parser, mocker):
        ...
        assert test_links == [
            (
                "test_root/manifests/degruyter/1.json",
                {"reader": True},
                "application/webpub+json",
                ("manifests/degruyter/1.json", "test_manifest_json"),
                None,
            ),
