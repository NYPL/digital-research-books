...
class TestGoogleBooksFetcher:
    ...
    def test_fetch_volume_success(self, test_fetcher, mocker):
        mock_get_api_response = mocker.patch.object(
            GoogleBooksFetcher, "get_api_response"
        )
        ...
        mock_get_api_response.assert_called_once_with(
            "https://www.googleapis.com/books/v1/volumes?q=isbn:1&key=test_api_key"
        )
    ...
    def test_fetch_cover_success(self, test_fetcher, mocker):
        ...
        mock_get_api_response.return_value = {
            "volumeInfo": {"imageLinks": {"large": "largeLink", "small": "smallLink"}}
        }
        ...
        mock_get_api_response.assert_called_once_with(
            "https://www.googleapis.com/books/v1/volumes/1?key=test_api_key"
        )
    ...
    def test_fetch_cover_no_matching_size(self, test_fetcher, mocker):
        ...
        mock_get_api_response.return_value = {
            "volumeInfo": {"imageLinks": {"large": "largeLink"}}
        }
