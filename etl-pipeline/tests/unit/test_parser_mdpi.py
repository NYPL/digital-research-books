...
class TestMDPIParser:
    ...
    def test_parser(self, mocker):
        ...
        return MDPIParser('mdpi.com/books/pdfview/book/1', 'application/pdf', mock_record)
    ...
    def test_create_links(self, test_parser, mocker):
        parser_mocks = mocker.patch.multiple(MDPIParser,
    ...
    def test_generate_pdf_links(self, test_parser, mocker):
        ...
        assert test_links == [
            ('test_root/manifests/mdpi/1.json', {'reader': True}, 'application/webpub+json', ('manifests/mdpi/1.json', 'test_manifest_json'), None),
