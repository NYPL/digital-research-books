...
class OpenEditionParser(ParserABC):
    ...
    def create_pdf_link(self, book_uri, book_type, book_flags):
        ...
        manifest_path = 'manifests/doab/{}_{}.json'.format(self.publisher, self.uri_identifier)
    ...
    def create_epub_link(self, book_uri, book_type, book_flags):
        ...
        ePub_download_path = 'epubs/doab/{}_{}.epub'.format(self.publisher, self.uri_identifier)
        ePub_download_uri = '{}{}'.format(s3_root, ePub_download_path)

        ePub_read_path = 'epubs/doab/{}_{}/META-INF/container.xml'.format(self.publisher, self.uri_identifier)
        ePub_read_uri = '{}{}'.format(s3_root, ePub_read_path)

        webpub_read_path = 'epubs/doab/{}_{}/manifest.json'.format(self.publisher, self.uri_identifier)
        ...
        return [
            ...
            (ePub_download_uri, {'download': True}, 'application/epub+zip', None, (ePub_download_path, book_uri))
        ]
    ...
    def parse_book_link(self, link):
        ...
        for format in self.FORMATS:
            ...
            if format_match:
                return (
                    '{}/{}/{}'.format('http://books.openedition.org', self.publisher, format_match.group(1)),
                    format['mediaType'],
                    format['flags']
                )
