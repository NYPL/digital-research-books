    ...
    def create_links(self):
        ...
        if self.media_type == 'application/pdf':
            ...
            return [
                ...
                (self.uri, {'reader': False, 'download': True}, self.media_type, None, None)
            ]
            ...
            epub_read_path = 'epubs/{}/{}/META-INF/container.xml'.format(self.source, self.identifier)
            epub_read_uri = '{}{}'.format(s3_root, epub_read_path)

            webpub_read_path = 'epubs/{}/{}/manifest.json'.format(self.source, self.identifier)
            ...
            return [
                ...
                (epub_download_uri, {'download': True}, self.media_type, None, (epub_download_path, self.uri))
            ]
