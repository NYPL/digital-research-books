...
class CatalogMapping(XMLMapping):
    ...
    def createMapping(self):
        return {
            "title": (
                "//oclc:datafield[@tag='245']/oclc:subfield[@code='a' or @code='b']/text()",
                "{0} {1}",
            ),
            "alternative": [
            ...
            "publisher": [
                (
                    "//oclc:datafield[@tag='260']/oclc:subfield[@code='b']/text()",
                    "{0}||",
                )
            ],
            "identifiers": [
                ...
                (
                    "//oclc:datafield[@tag='010']/oclc:subfield[@code='a']/text()",
                    "{0}|lccn",
                ),
                (
                    "//oclc:datafield[@tag='020']/oclc:subfield[@code='a']/text()",
                    "{0}|isbn",
                ),
                (
                    "//oclc:datafield[@tag='022']/oclc:subfield[@code='a']/text()",
                    "{0}|issn",
                ),
                (
                    "//oclc:datafield[@tag='050']/oclc:subfield[@code='a']/text()",
                    "{0}|lcc",
                ),
                (
                    "//oclc:datafield[@tag='082']/oclc:subfield[@code='a']/text()",
                    "{0}|ddc",
                ),
                (
                    "//oclc:datafield[@tag='010']/oclc:subfield[@code='z']/text()",
                    "{0}|lccn",
                ),
                (
                    "//oclc:datafield[@tag='020']/oclc:subfield[@code='z']/text()",
                    "{0}|isbn",
                ),
                (
                    "//oclc:datafield[@tag='022']/oclc:subfield[@code='z']/text()",
                    "{0}|issn",
                ),
                (
                    "//oclc:datafield[@tag='050']/oclc:subfield[@code='z']/text()",
                    "{0}|lcc",
                ),
                (
                    "//oclc:datafield[@tag='082']/oclc:subfield[@code='z']/text()",
                    "{0}|dcc",
                ),
            ],
            "contributors": [
                (
                    "//oclc:datafield[@tag='260']/oclc:subfield[@code='f']/text()",
                    "{0}|||manufacturer",
                ),
                (
                    "//oclc:datafield[@tag='700']/oclc:subfield[@code='f']/text()",
                    "{0}|||contributor",
                ),
                (
                    "//oclc:datafield[@tag='710']/oclc:subfield[@code='f']/text()",
                    "{0}|||contributor",
                ),
                (
                    "//oclc:datafield[@tag='711']/oclc:subfield[@code='f']/text()",
                    "{0}|||contributor",
                ),
            ],
            ...
            "dates": [
                (
                    "//oclc:datafield[@tag='260']/oclc:subfield[@code='c']/text()",
                    "{0}|publication_date",
                ),
                (
                    "//oclc:datafield[@tag='264']/oclc:subfield[@cod='c']/text()",
                    "{0}|copyright_date",
                ),
            ],
            "extent": (
            ...
            "abstract": (
                "//oclc:datafield[@tag='520']/oclc:subfield[@code='a']/text()",
                "{0}",
            ),
            "table_of_contents": (
                "//oclc:datafield[@tag='505']/oclc:subfield[@code='a']/text()",
                "{0}",
            ),
            "subjects": [
                (
    ...
    def applyFormatting(self):
        ...
        self.record.identifiers[0] = self.remove_oclc_prefixes(
            self.record.identifiers[0]
        )
        ...
        self.record.has_part = list(
            filter(None, [self.parseLink(p) for p in self.record.has_part])
        )
    ...
    def parseLink(self, part):
        ...
        for source, sourceRegex in self.EBOOK_REGEX.items():
            ...
            if sourceMatch:
                ...
                return "|".join(
                    [partNo, partLink, partSource, partFormat, json.dumps(partDict)]
                )
    ...
    def checkIAReadability(self, iaURL):
        ...
        try:
            ...
            logger.exception(
                f"Failed to check Internet Archive readability for {iaURL}"
            )
            return False
